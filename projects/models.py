...
class Project(models.Model):
    ...
    maintainer = models.ForeignKey(User, related_name="maintained_projects", verbose_name='Mainteneur', on_delete=models.CASCADE)
...
class Task(models.Model):
    ...
    proposed_by = models.ForeignKey(User, related_name='proposed_tasks', verbose_name='Proposé par', on_delete=models.CASCADE)
    proposed_on = models.DateTimeField(verbose_name='Date de création', auto_now_add=True)

    completed_by = models.ForeignKey(User, related_name='completed_tasks', verbose_name='Réalisé par', null=True, blank=True, on_delete=models.CASCADE)
